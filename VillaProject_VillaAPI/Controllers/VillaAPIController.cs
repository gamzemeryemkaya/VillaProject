...
using System.Data;
using System.Net;
using VillaProject_VillaAPI.Data;
using VillaProject_VillaAPI.Models;
using VillaProject_VillaAPI.Models.Dto;

namespace VillaProject_VillaAPI.Controllers
{
    ...
    public class VillaAPIController : ControllerBase
    {
        ...
        public async Task<ActionResult<VillaDTO>> CreateVilla([FromBody] VillaDTO villaDTO)
        {
            ...
            {
                ModelState.AddModelError("ErrorMessages", "Villa zaten var");
